    ...
    <div>
      <div className='flex flex-row items-center gap-2 md:gap-5 py-2'>
        ...
        <div className="flex items-center gap-2">
          <h1 className="text-sm md:text-base">{item?.menuItemId?.title}</h1>
        </div>
        <h1 className="text-sm md:text-base">$ {item?.menuItemId?.price}</h1>
        <h1 className="text-sm md:text-base">qty: {item?.quantity}</h1>
      </div>
    </div>
  )
}
